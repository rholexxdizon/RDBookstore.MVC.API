...
namespace RDBookstoreMVC.Controllers
{
    public class BooksController : Controller
    {
        ...
        // GET: Customer/Details/5 - Get Certain Books
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Price,Overview,Summary,Publisher,Pages,Length,Width,Height,Genre")] Books books)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Price,Overview,Summary,Publisher,Pages,Length,Width,Height,Genre")] Books books)
        {
            if (id != books.Id)
            {
                return NotFound();
